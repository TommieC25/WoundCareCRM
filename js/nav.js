...
html += `<div style="margin-bottom:0.75rem;"><div onclick="var b=this.nextElementSibling;var o=b.style.display!=='none';b.style.display=o?'none':'block';this.querySelector('span').textContent=o?'▶':'▼';" style="cursor:pointer;user-select:none;font-size:0.75rem;font-weight:700;color:#92400e;text-transform:uppercase;letter-spacing:0.5px;margin-bottom:0.5rem;padding-bottom:0.25rem;border-bottom:2px solid #fcd34d;display:flex;justify-content:space-between;align-items:center;">${isToday ? '📅 TODAY — ' : ''}${label}<span style="font-size:1.1rem;">▼</span></div><div>`;
...
html += `<div style="margin-bottom:0.5rem;"><div onclick="var b=this.nextElementSibling;var o=b.style.display!=='none';b.style.display=o?'none':'block';this.querySelector('span').textContent=o?'▶':'▼';" style="cursor:pointer;user-select:none;font-size:0.75rem;font-weight:700;color:#6b7280;text-transform:uppercase;letter-spacing:0.5px;margin-bottom:0.5rem;padding-bottom:0.25rem;border-bottom:2px solid #d1d5db;display:flex;justify-content:space-between;align-items:center;">📌 Open (${openReminders.length})<span style="font-size:1.1rem;">▶</span></div><div style="display:none">`;
